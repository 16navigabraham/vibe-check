...
export function ConnectWalletLanding() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-20">
      ...
      <h1 className="text-5xl md:text-6xl font-bold font-headline mb-4 animate-in fade-in slide-in-from-top-4 duration-1000">
        Welcome to <span className="text-primary">VibeCheck</span>
      </h1>
      <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8 animate-in fade-in slide-in-from-top-2 duration-1000 delay-300">
